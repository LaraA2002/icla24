...
# img.save("exercise1part1" + sys.argv[1])
...
# img.save("exercise1part2" + sys.argv[1])
...
# img.save("exercise1part3" + sys.argv[1])
...
# img.save("exercise1part4" + sys.argv[1])
...
# img_rgb.save("filtered.jpg" + sys.argv[1])
